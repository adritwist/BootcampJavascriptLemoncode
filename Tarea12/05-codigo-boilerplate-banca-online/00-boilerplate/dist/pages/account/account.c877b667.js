...
})({"1pwXq":[function(require,module,exports) {
"use strict";
...
if (isEditMode) (0, _accountApi.getAccount)(params.id).then((apiAccount)=>{
    account = (0, _accountMappers.mapAccountApiToVm)(apiAccount);
...
(0, _helpers.onUpdateField)("type", (event)=>{
    const value = event.target.value;
    account = {
        ...account,
        type: value
    };
    (0, _accountValidations.formValidation).validateField("type", account.type).then((result)=>{
        (0, _helpers.onSetError)("type", result);
    });
});
(0, _helpers.onUpdateField)("alias", (event)=>{
    const value = event.target.value;
    account = {
        ...account,
        alias: value
    };
    (0, _accountValidations.formValidation).validateField("alias", account.alias).then((result)=>{
        (0, _helpers.onSetError)("alias", result);
    });
});
const onSave = ()=>{
    const apiAccount = (0, _accountMappers.mapAccountVmToApi)(account);
    return isEditMode ? (0, _accountApi.updateAccount)(apiAccount) : (0, _accountApi.insertAccount)(apiAccount);
};
(0, _helpers.onSubmitForm)("save-button", ()=>{
    (0, _accountValidations.formValidation).validateForm(account).then((result)=>{
        (0, _helpers.onSetFormErrors)(result);
        if (result.succeeded) onSave().then(()=>{
            (0, _router.history).back();
        });
    });
});

},{"../../common/helpers":"tIcrk","../../core/router":"cgVhd","./account.validations":"gzC9n","./account.api":"lIm4y","./account.mappers":"1TrSU"}],"tIcrk":[function(require,module,exports) {
...
},{"./utils":"chmkc"}],"gzC9n":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lIm4y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const insertAccount = (account)=>(0, _axiosDefault.default).post(`${url}/${account.id}`, account).then((response)=>{
        return response.data;
    });
const getAccount = (id)=>(0, _axiosDefault.default).get(`${url}/${id}`).then((response)=>{
        return response.data;
    });
const updateAccount = (account)=>(0, _axiosDefault.default).put(`${url}/${account.id}`, account).then((response)=>{
        return response.data;
    });
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mapAccountVmToApi", ()=>mapAccountVmToApi);
parcelHelpers.export(exports, "mapAccountApiToVm", ()=>mapAccountApiToVm);
const mapAccountVmToApi = (account)=>({
        ...account,
        name: account.alias
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1pwXq","2wjZh"], "2wjZh", "parcelRequire4bdb")
