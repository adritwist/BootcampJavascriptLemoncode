...
})({"3syHQ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "fddb738baa551ab1";
...
},{}],"jbtVU":[function(require,module,exports) {
var _accountListApi = require("./account-list.api");
var _accountListHelpers = require("./account-list.helpers");
var _accountListMappers = require("./account-list.mappers");
var _helpers = require("../../common/helpers");
var _router = require("../../core/router");
const setEvents = (accountList)=>{
    accountList.forEach((account)=>{
        (0, _helpers.onUpdateField)(`select-${account.id}`, (event)=>{
            const route = event.target.value;
            (0, _router.history).push(route);
        });
    });
};
(0, _accountListApi.getAccountList)().then((accountList)=>{
    const vmAccountList = (0, _accountListMappers.mapAccountListApiToVm)(accountList);
    (0, _accountListHelpers.addAccountRows)(vmAccountList);
    setEvents(vmAccountList);
});

},{"./account-list.api":"3FwKx","./account-list.helpers":"faoKe","./account-list.mappers":"c7BOz","../../common/helpers":"tIcrk","../../core/router":"cgVhd"}],"3FwKx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAccountList", ()=>getAccountList);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const url = `${"http://localhost:3000/api"}/account-list`;
const getAccountList = ()=>(0, _axiosDefault.default).get(url).then(({ data  })=>data);
...
},{}],"faoKe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addAccountRows", ()=>addAccountRows);
var _router = require("../../core/router");
const getOptions = (id)=>{
    const emptyOption = document.createElement("option");
    const transferOption = document.createElement("option");
    transferOption.textContent = "Transferencias";
    transferOption.value = (0, _router.routes).transfer(id);
    const movementOption = document.createElement("option");
    movementOption.textContent = "Movimientos";
    movementOption.value = (0, _router.routes).movements(id);
...
const getAccountRow = (account)=>{
    ...
    ibanAnchor.href = (0, _router.routes).account(account.id);
...
const addAccountRows = (accountList)=>{
    accountList.forEach((account)=>{
...
},{"../../core/router":"cgVhd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cgVhd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./utils":"chmkc"}],"c7BOz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mapAccountListApiToVm", ()=>mapAccountListApiToVm);
const mapAccountListApiToVm = (accountList)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3syHQ","jbtVU"], "jbtVU", "parcelRequire4bdb")

//# sourceMappingURL=account-list.aa551ab1.js.map
