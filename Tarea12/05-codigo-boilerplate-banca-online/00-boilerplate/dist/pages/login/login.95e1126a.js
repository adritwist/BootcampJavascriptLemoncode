...
})({"8AzaQ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "21837f7b95e1126a";
...
},{}],"dnRSK":[function(require,module,exports) {
var _helpers = require("../../common/helpers");
var _loginApi = require("./login.api");
var _loginValidations = require("./login.validations");
var _router = require("../../core/router");
let login = {
    user: "",
    password: ""
};
(0, _helpers.onUpdateField)("user", (event)=>{
    const value = event.target.value;
    login = {
        ...login,
        user: value
    };
    (0, _loginValidations.formValidation).validateField("user", login.user).then((result)=>{
        (0, _helpers.onSetError)("user", result);
    });
});
(0, _helpers.onUpdateField)("password", (event)=>{
    const value = event.target.value;
    login = {
        ...login,
        password: value
    };
    (0, _loginValidations.formValidation).validateField("password", login.password).then((result)=>{
        (0, _helpers.onSetError)("password", result);
    });
});
const onNavigate = (isValid)=>{
    if (isValid) (0, _router.history).push((0, _router.routes).accountList);
    else alert("Usuario y/o contrase\xf1a no v\xe1lidos");
};
(0, _helpers.onSubmitForm)("login-button", ()=>{
    (0, _loginValidations.formValidation).validateForm(login).then((result)=>{
        (0, _helpers.onSetFormErrors)(result);
        if (result.succeeded) (0, _loginApi.isValidLogin)(login).then((isValid)=>{
            onNavigate(isValid);
        });
    });
});

},{"../../common/helpers":"tIcrk","./login.api":"aWcJp","./login.validations":"2LnF3","../../core/router":"cgVhd"}],"tIcrk":[function(require,module,exports) {
...
},{}],"aWcJp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "isValidLogin", ()=>isValidLogin);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const url = `${"http://localhost:3000/api"}/login`;
const isValidLogin = (login)=>(0, _axiosDefault.default).post(url, login).then((response)=>{
...
},{"./../utils":"5By4s"}],"2LnF3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./utils":"chmkc"}]},["8AzaQ","dnRSK"], "dnRSK", "parcelRequire4bdb")

//# sourceMappingURL=login.95e1126a.js.map
