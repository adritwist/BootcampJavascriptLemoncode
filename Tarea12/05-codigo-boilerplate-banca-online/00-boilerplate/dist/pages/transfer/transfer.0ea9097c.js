...
})({"9UqL9":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "1741d6450ea9097c";
...
},{}],"j0rFS":[function(require,module,exports) {
var _movementsListApi = require("../movements/movements-list.api");
var _router = require("../../core/router");
var _transferHelpers = require("./transfer.helpers");
var _helpers = require("../../common/helpers");
var _transferValidations = require("./transfer.validations");
var _transferApi = require("./transfer.api");
var _transferMappers = require("./transfer.mappers");
const params = (0, _router.history).getParams();
const isEditMode = Boolean(params.id);
if (isEditMode) (0, _movementsListApi.getAccount)(params.id).then((ApiAccount)=>{
    (0, _transferHelpers.setAccountOptions)(ApiAccount);
});
else (0, _movementsListApi.getAccount)().then((ApiAccount)=>{
    (0, _transferHelpers.setAccountOptions)(ApiAccount);
});
let transfer = {
    iban: "",
...
(0, _helpers.onUpdateField)("select-account", (event)=>{
    const value = event.target.value;
    transfer = {
        ...transfer,
        accountId: value
    };
    (0, _transferValidations.formValidation).validateField("select-account", transfer.accountId).then((result)=>{
        (0, _helpers.onSetError)("select-account", result);
    });
});
(0, _helpers.onUpdateField)("iban", (event)=>{
    const value = event.target.value;
    transfer = {
        ...transfer,
        iban: value
    };
    (0, _transferValidations.formValidation).validateField("iban", transfer.iban).then((result)=>{
        (0, _helpers.onSetError)("iban", result);
    });
});
(0, _helpers.onUpdateField)("name", (event)=>{
    const value = event.target.value;
    transfer = {
        ...transfer,
        name: value
    };
    (0, _transferValidations.formValidation).validateField("name", transfer.name).then((result)=>{
        (0, _helpers.onSetError)("name", result);
    });
});
(0, _helpers.onUpdateField)("amount", (event)=>{
    const value = event.target.value;
    transfer = {
        ...transfer,
        amount: value
    };
    (0, _transferValidations.formValidation).validateField("amount", transfer.amount).then((result)=>{
        (0, _helpers.onSetError)("amount", result);
    });
});
(0, _helpers.onUpdateField)("concept", (event)=>{
    const value = event.target.value;
    transfer = {
        ...transfer,
        concept: value
    };
    (0, _transferValidations.formValidation).validateField("concept", transfer.concept).then((result)=>{
...
(0, _helpers.onUpdateField)("day", (event)=>{
    const value = event.target.value;
    transfer = {
        ...transfer,
        day: value,
    ...
    (0, _transferValidations.formValidation).validateField("day", transfer.day).then((result)=>{
        (0, _helpers.onSetError)("day", result);
    });
});
(0, _helpers.onUpdateField)("month", (event)=>{
    const value = event.target.value;
    transfer = {
        ...transfer,
        month: value,
    ...
    (0, _transferValidations.formValidation).validateField("month", transfer.month).then((result)=>{
        (0, _helpers.onSetError)("month", result);
    });
});
(0, _helpers.onUpdateField)("year", (event)=>{
    const value = event.target.value;
    transfer = {
        ...transfer,
        year: value,
    ...
    (0, _transferValidations.formValidation).validateField("year", transfer.year).then((result)=>{
...
(0, _helpers.onUpdateField)("email", (event)=>{
    ...
    (0, _transferValidations.formValidation).validateField("email", transfer.email).then((result)=>{
        (0, _helpers.onSetError)("email", result);
    });
});
(0, _helpers.onSubmitForm)("transfer-button", ()=>{
    (0, _transferValidations.formValidation).validateForm(transfer).then((result)=>{
        (0, _helpers.onSetFormErrors)(result);
        const toApi = (0, _transferMappers.mapTransferFromApiToVm)(transfer);
        console.log(toApi);
        if (result.succeeded) (0, _transferApi.insertTransfer)(toApi).then(()=>{
            (0, _router.history).back();
        });
    });
});

},{"../movements/movements-list.api":"kaROi","../../core/router":"cgVhd","./transfer.helpers":"7xdm4","../../common/helpers":"tIcrk","./transfer.validations":"8VcSN","./transfer.api":"dhQ6z","./transfer.mappers":"iyYpH"}],"kaROi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getmovementsList", ()=>getmovementsList);
parcelHelpers.export(exports, "getAccount", ()=>getAccount);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const url = `${"http://localhost:3000/api"}/movements`;
const url2 = `${"http://localhost:3000/api"}/account-list`;
const getmovementsList = (id)=>(0, _axiosDefault.default).get(url, {
        params: {
            accountId: id
        }
    }).then((response)=>{
...
const getAccount = (id)=>(0, _axiosDefault.default).get(url2, {
        params: {
            id: id
        }
    }).then((response)=>{
...
},{}],"cgVhd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./utils":"chmkc"}],"7xdm4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setAccountOptions", ()=>setAccountOptions);
...
const setAccountOptions = (accounts, selectedId)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8VcSN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _fonkLaterDateValidator = require("@lemoncode/fonk-later-date-validator");
const validationSchema = {
    field: {
        iban: [
            ...
            {
                validator: (0, _fonkIbanValidator.iban).validator,
        ...
        name: [
            ...
            },
            {
                ...
                message: "El valor introducido no cumple con la longitud m\xednima"
            }, 
        ],
        amount: [
            {
        ...
        year: [
            {
                validator: (0, _fonk.Validators).pattern,
                customArgs: {
                    pattern: /^2[0-9][2-9](\d{1})$/
                }
            }, 
        ],
        date: [
            {
                validator: (0, _fonkLaterDateValidator.laterDate).validator,
                customArgs: {
        ...
        email: [
            {
                ...
                message: "EL email introducido no es v\xe1lido"
            }, 
        ]
    }
};
...
},{"@lemoncode/fonk":"lVeW7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@lemoncode/fonk-iban-validator":"go3cb","@lemoncode/fonk-positive-number-validator":"aClLh","@lemoncode/fonk-later-date-validator":"kgb4Y"}],"lVeW7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FormValidation", ()=>FormValidation);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"go3cb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "iban", ()=>validator$1);
...
var validator = function validator(fieldValidatorArgs) {
    var value = fieldValidatorArgs.value, _fieldValidatorArgs$m = fieldValidatorArgs.message, message = _fieldValidatorArgs$m === void 0 ? defaultMessage : _fieldValidatorArgs$m;
...
},{"@lemoncode/fonk":"lVeW7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kgb4Y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "laterDate", ()=>validator$1);
var _fonk = require("@lemoncode/fonk");
...
var parseToDate = function parseToDate(value, _ref) {
    ...
    if (!parseStringToDateFn) throw new Error(MISSING_PARSE_ARGS);
...
var validator = function validator(_ref2) {
    var value = _ref2.value, _ref2$message = _ref2.message, message = _ref2$message === void 0 ? defaultMessage : _ref2$message, _ref2$customArgs = _ref2.customArgs, customArgs = _ref2$customArgs === void 0 ? defaultCustomArgs : _ref2$customArgs;
    var args = Object.assign(Object.assign({}, defaultCustomArgs), customArgs);
    if (!args || !args.date) throw new Error(MISSING_DATE_ARGS);
...
},{"@lemoncode/fonk":"lVeW7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dhQ6z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "insertTransfer", ()=>insertTransfer);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const url = `${"http://localhost:3000/api"}/transfer`;
const insertTransfer = (transfer)=>(0, _axiosDefault.default).post(url, transfer).then((response)=>{
        return response.data;
    });

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iyYpH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mapTransferFromApiToVm", ()=>mapTransferFromApiToVm);
const mapTransferFromApiToVm = (transfer)=>{
    return {
        ...transfer,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9UqL9","j0rFS"], "j0rFS", "parcelRequire4bdb")

//# sourceMappingURL=transfer.0ea9097c.js.map
