...
})({"7G88i":[function(require,module,exports) {
"use strict";
...
Promise.all([
    (0, _propertyDetailApi.getHomes)(params.id),
    (0, _propertyDetailApi.getEquipmentsList)()
]).then(([propertyList, equipmentsList])=>{
    loadHomes(propertyList, equipmentsList);
});
const loadHomes = (propertyList, equipmentsList)=>{
    const viewModelPropertyList = (0, _propertyDetailMappers.mapPropertyDetailApiToVm)(propertyList, equipmentsList);
    (0, _propertyDetailHelpers.setPropertyValues)(viewModelPropertyList);
};
let contact = {
    email: "",
    message: ""
...
(0, _helpers.onUpdateField)("message", (event)=>{
    const value = event.target.value;
    contact = {
        ...contact,
        message: value
    };
    (0, _propertyDetailValidations.formValidation).validateField("message", contact.message).then((result)=>{
        (0, _helpers.onSetError)("message", result);
    });
});
(0, _helpers.onSubmitForm)("contact-button", ()=>{
    (0, _propertyDetailValidations.formValidation).validateForm(contact).then((result)=>{
        (0, _helpers.onSetFormErrors)(result);
        console.log(result);
        const toApi = (0, _propertyDetailMappers.mapContactVmToApi)(contact);
        if (result.succeeded) (0, _propertyDetailApi.insertContact)(toApi).then(()=>{
            (0, _router.history).back();
        });
    });
});

},{"./property-detail.api":"675is","./property-detail.mappers":"fd7bK","./property-detail.helpers":"fj9W2","../../core/router":"cgVhd","../../common/helpers":"tIcrk","./property-detail.validations":"j2IvS"}],"675is":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getHomes", ()=>getHomes);
parcelHelpers.export(exports, "getEquipmentsList", ()=>getEquipmentsList);
parcelHelpers.export(exports, "insertContact", ()=>insertContact);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const url = `${"http://localhost:3000/api"}/properties`;
const getHomes = (id)=>(0, _axiosDefault.default).get(`${url}/${id}`).then((response)=>{
...
const sendContact = `${"http://localhost:3000/api"}/contact`;
const insertContact = (contact)=>(0, _axiosDefault.default).post(sendContact, contact).then((response)=>{
        return response.data;
    });
...
const mapPropertyDetailApiToVm = (property, equipmentsList)=>{
    return {
...
const getBathroomsWord = (bathrooms)=>bathrooms > 1 ? "ba\xf1os" : "ba\xf1o";
...
const mapContactVmToApi = (contact, property)=>{
    return {
...
},{"./utils":"chmkc"}],"tIcrk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
    ...
    field: {
        ...
        message: [
            ...
            },
            {
                ...
                message: "El valor proporcionado no cumple con la longitud m\xednima"
            }, 
        ]
    }
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7G88i","aoGpU"], "aoGpU", "parcelRequire4bdb")
